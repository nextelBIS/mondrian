...
public enum PropertyDefinition {
    ...
    DbpropMsmdMDXCompatibility(RowsetDefinition.Type.Integer, null,
            XmlaConstants.Access.ReadWrite, "1",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            "DbpropMsmdMDXCompatibility"),

    MdxMissingMemberMode(RowsetDefinition.Type.String, null,
            XmlaConstants.Access.ReadWrite, "Error",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE, "DbpropMsmdSubqueries"),

    SafetyOptions(RowsetDefinition.Type.Integer, null,
            XmlaConstants.Access.ReadWrite, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE, "SafetyOptions"),

    MdpropMdxDrillFunctions(RowsetDefinition.Type.Integer, null,
            XmlaConstants.Access.Read, "3",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
